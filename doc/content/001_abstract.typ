...
Data point selection forms the core. A fully populated line of one Powercenter and 24 end devices comprises 3859 register map entries. Seven criteria reduce this to 904 registers read, roughly 77 percent fewer entries. The result comprises machine-readable type descriptions for both devices, a listing of register, format and justification, and a document for installers and operators.
