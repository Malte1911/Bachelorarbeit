...
Den Zugang in dieses Segment regelt eine vorgelagerte Firewall. Für den Aufbau sind dort die Ports 80 und 443 für #acro("HTTP") und #acro("HTTPS") sowie der Port 502 für Modbus #acro("TCP") freigegeben, wobei die ersten beiden den Zugang von SENTRON Powerconfig nach @sec:geraetekonfiguration tragen und der letzte den laufenden Datenpfad. Innerhalb des Segments wirkt diese Freigabe nicht, da Desigo CC und Powercenter dort unmittelbar benachbart sind. Der Schutz liegt somit an der Segmentgrenze und entspricht der Sache nach dem, was RB-06 verlangt. Ein Nachweis liegt darin gleichwohl nicht, denn ein einzelner Laboraufbau in einem gemeinsamen #acro("VLAN") sagt nichts über eine Kundenanlage mit mehreren Strängen aus. // letzten Satz bitte nochmal umformulieren
