...
Der Aufbau besteht aus einem SENTRON Powercenter 1100 als Datentransceiver und einem elektronischen Schutzschaltgerät 5TY1-3MF16 COM, der $16space.thin"A"$ Nennstrom-Variante, als Endgerät, wie es RB-04 vorsieht. Beide Geräte entsprechen damit den in @sec:ecpd und @sec:powercenter beschriebenen Typen. Das Powercenter arbeitet mit dem Firmwarestand 7.3.0, das #acro("ECPD") mit dem Stand 5.5.0. Sowohl der Umfang der verfügbaren Gerätefunktionen als auch die Registerkarte sind an den Firmwarestand gebunden @src:sentronsystemhandbuch.
