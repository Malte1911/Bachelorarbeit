...
Die Last wird über eine Steckdosenleiste am Abgang des #acro("ECPD") aufgeschaltet. Als Verbraucher dienen zwei Wasserkocher mit je $1800space.thin"W"$, die bei $230space.thin"V"$ zusammen rund $15,7space.thin"A"$ aufnehmen. Der Wert ist aus den Leistungsangaben der Geräte gerechnet. Damit lässt sich sowohl ein Betriebspunkt für den in T-04 geforderten Vergleich der Messwerte herstellen als auch die Überlast erzeugen, die T-06 als einzigen am Aufbau gefahrlos herbeiführbaren Alarm nutzt.
