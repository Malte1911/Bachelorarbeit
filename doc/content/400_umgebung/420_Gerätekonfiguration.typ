...
Von besonderer Bedeutung für die Prüfung sind die Alarme. Nach @sec:registerraum ist nur ein kleinerer Teil der Alarmbits ab Werk aktiv, die übrigen liefern ohne vorherige Einstellung in SENTRON Powerconfig dauerhaft den Wert null. Betroffen sind unter anderem die beiden #acro("RCM")-Alarme, die zu den aussagekräftigsten Meldungen des Geräts zählen. Hierauf zielt NFA-06, und T-14 prüft den Unterschied zwischen dem Auslieferungszustand und dem eingeschalteten Zustand. Ohne diesen Schritt wäre ein Teil der abgebildeten Datenpunkte am Testaufbau nicht beobachtbar, ohne dass dies etwas über das Datenmodell aussagen würde. Am Testaufbau werden deshalb alle Alarme eingeschaltet, die einen solchen Schalter besitzen. Die zugehörigen Grenzwerte und Hysteresen bleiben auf den Voreinstellungen des Geräts. Einzelne Grenzwerte werden allein dort herabgesetzt, wo ein Alarm am Aufbau sonst nicht in vertretbarer Zeit auslöst und sein Weg bis in Desigo CC deshalb nicht zu verfolgen wäre. Ein solcher Eingriff verschiebt den Auslösezeitpunkt und lässt das Verhalten des Datenpunkts unberührt. // #kommentar[Wird im Validierungsteil ein Alarm mit einem zu Prüfzwecken herabgesetzten Grenzwert ausgelöst, gehört der geänderte Wert an die betreffende Stelle, damit die Beobachtung nicht dem Auslieferungszustand zugeschrieben wird.]
