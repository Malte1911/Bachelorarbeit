...
#kommentar[Hier gehoert die Abgrenzung gegenueber dem Stand der Technik hin, bewusst zu eigenen Ungunsten. Mit Brick liegt ein herstellerneutrales, allgemeines Schema zur Beschreibung von Anlagenteilen und Messpunkten vor @src:balaji2018, waehrend diese Arbeit eine plattformspezifische Typbeschreibung liefert. Ein allgemeines Schema war nie das Ziel, weshalb die Feststellung nichts kostet und zeigt, dass die Quelle ausgewertet und nicht nur angefuehrt wurde.]
