...
Für das Projektgeschäft ergibt sich damit eine geteilte Bewertung. Als Vorlage für die Anbindung ist das Modell einsetzbar und nimmt dem Errichter die wiederkehrende Zuordnungsarbeit ab, die nach @src:wang2018 arbeitsintensiv und kostentreibend bleibt. Als vollständige Leitwartenanbindung eines Schutzgeräts bleibt es hinter dem Ziel zurück, solange die Meldungen nicht als einzelne Zustände vorliegen und sich die Alarmierung deshalb auch in der Projektierung nicht einrichten lässt. Welcher wirtschaftliche Nutzen unter dieser Einschränkung verbleibt, behandelt @sec:nachhaltigkeit.
