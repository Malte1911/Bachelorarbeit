...
=== Schnittstellen<sec:powercenter_schnittstellen> // Claude: hier fehlen komplett die Quellen und Verweise auf Handbücher etc, eigentlich in dem gesamten Abschnitt
