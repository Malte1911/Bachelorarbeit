...
Genau an dieser Stelle setzt die neuere Forschung an. Mit Brick liegt ein Schema vor, das Anlagenteile, Messpunkte und deren Beziehungen maschinenlesbar beschreibt, mit dem ausdrücklichen Ziel, Anwendungen von einem Gebäude auf ein anderes übertragbar zu machen @src:balaji2018. Die zugrunde liegende Beobachtung deckt sich mit der Ausgangslage dieser Arbeit. Ein Datenpunkt ist erst dann verwertbar, wenn feststeht, welche Größe er abbildet, in welcher Einheit, in welchem Zustandsraum und zu welchem Gerät er gehört. Die Typbeschreibung, die im Rahmen dieser Arbeit entsteht, leistet für die betrachtete Gerätefamilie dasselbe, wenn auch mit den Mitteln und in der Ausdruckskraft der Zielplattform und nicht als allgemeines Schema.
