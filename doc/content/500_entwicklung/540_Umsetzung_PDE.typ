...
Dass beide Wege gleich enden, ist dabei der aussagekräftigere Teil der Beobachtung. Sie unterscheiden sich im Werkzeug erheblich, denn der eine bindet einen Wahrheitswert über einen Subindex an eine Bitstelle, der andere schneidet Messpunkte aus einem Registerbereich heraus. Auf Protokollebene sind sie kaum zu unterscheiden, weil in beiden Fällen derselbe Registerbereich mit demselben Funktionscode gelesen wird. Ein gleiches Ergebnis bei verschiedener Beschreibung und gleichem Telegramm spricht dafür, dass die Ursache auf der auswertenden Seite liegt und nicht am Gerät.
