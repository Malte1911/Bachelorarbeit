...
Für das Powercenter fällt die Reduktion deutlicher aus, und zwar aus einem einzigen Grund. Von den 211 Einträgen der Registerkarte entfallen 126 auf Funkparameter, überwiegend auf Felder je Endgeräteplatz, dazu auf Schalterzustände, Zähler von Parameteränderungen sowie Pairing-, Verbindungs- und Identifikationszustände. Sie sämtlich am Powercenter abzubilden hieße, jeden dieser Werte doppelt zu führen und bis zu 24 fremde Geräte in ein Objekt zu mischen. K-04 löst diese Doppelung zugunsten des Endgeräts auf und trägt damit den größten Teil des Ausschlusses.
