...
Die Kriterien werden von Hand angewandt. Verfahren, die eine solche Zuordnung selbsttätig erzeugen, setzen uneinheitlich benannte Datenpunkte voraus und erreichen dort eine mittlere Trefferquote von 91,4 Prozent, wobei eine Prüfung durch den Menschen erforderlich bleibt @src:zhan2020. Für den hier betrachteten Fall entfällt diese Voraussetzung, da die Benennung der Register bereits feststeht. Die zu leistende Arbeit liegt eine Stufe später und besteht in der Entscheidung, welche Register die Anwendungsfälle tragen und wie sie im Objektmodell zu führen sind. Der Aufwand fällt dabei nur einmal an. Die Zuordnung der Datenpunkte eines Gebäudeleitsystems zu einer einheitlichen Beschreibung erfolgt nach dem Stand der Technik überwiegend von Hand und bleibt arbeitsintensiv und kostentreibend @src:wang2018, während sie hier an den Gerätetyp gebunden ist und in Folgeprojekten erhalten bleibt.
