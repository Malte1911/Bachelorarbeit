...
Die vorliegende Arbeit entwickelt dafür eine wiederverwendbare Integrationsvorlage und weist sie an einem Hardwareaufbau nach. Das Vorgehen folgt dem V-Modell. Aus einer System- und Stakeholderanalyse gehen elf Anwendungsfälle hervor, daraus fünfzehn Anforderungen und vierzehn Testfälle, womit jede Festlegung des Modells auf eine Tätigkeit einer benannten Nutzergruppe zurückführbar bleibt.

Den Kern bildet die Auswahl der Datenpunkte. Ein voll bestückter Strang aus einem Powercenter und 24 Endgeräten umfasst 5169 Datenpunkte der Registerkarte, die weder sinnvoll darstellbar noch im geforderten Takt abfragbar sind. Sieben Auswahlkriterien senken diesen Umfang auf 929 gelesene Register und damit die Abfragelast um rund 82 Prozent. Das Ergebnis besteht aus maschinenlesbaren Typbeschreibungen für beide Gerätetypen, einer Aufstellung, die zu jedem Datenpunkt Register, Format und Begründung festhält, sowie einer Unterlage für Errichter und Betreiber.

Die Validierung weist neun der fünfzehn Anforderungen als erfüllt aus, drei als teilweise und drei als nicht erfüllt. Messwerte, Zählerstände, Stammdaten und der Schalterzustand erscheinen vollständig und richtig beschriftet, Schaltbefehle werden ausgeführt und quittiert. Offen bleibt die Alarmierung, da sämtliche Meldungen in einem Sammelregister liegen und sich mit der eingesetzten Werkzeugkette nicht in einzeln auswertbare Zustände zerlegen lassen. Die Prüfung belegt darüber hinaus Eigenschaften der Geräte und der Plattform, die kein Datenmodell beheben kann, darunter die nur örtlich zu erteilende Freigabe des Fernschaltens, ab Werk abgeschaltete Alarmbits und ein nur geräteübergreifend einstellbares Abfrageintervall.

Für das Projektgeschäft ergibt sich eine geteilte Bewertung. Als Vorlage nimmt das Modell die wiederkehrende Zuordnungsarbeit ab und trägt die Beobachtung und Auswertung eines Verteilers aus der Leitwarte. Als vollständige Leitwartenanbindung eines Schutzgeräts trägt es nicht, solange die Störungsbearbeitung eine je Anlage von Hand einzurichtende Alarmierung voraussetzt.
