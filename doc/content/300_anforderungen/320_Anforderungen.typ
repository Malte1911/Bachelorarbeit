...
/* Claude: Am 02.09.2026 gekuerzt. Der hier zuvor stehende Absatz
   ("Diese Arbeitsteilung ist keine vorlaeufige Einschraenkung, sondern
   beabsichtigt ...") gab den Schlussabsatz von @sec:konzept in voller Laenge
   wieder, einschliesslich der Zustaendigkeitsfrage zwischen Elektrofachkraft
   und Gebaeudeverwaltung. Der vorangehende Absatz verweist mit "die in
   @sec:konzept eingefuehrte Arbeitsteilung" bereits dorthin. Erhalten ist
   allein der Satz zu den geschuetzten Parametern, weil er den Zuschnitt von
   FA-06 und FA-09 am Geraeteverhalten belegt und in @sec:konzept nicht steht. */
