...
#figure(
  table(
    ...
    [RB-01],
    [Zur Einrichtung sind die Software SENTRON Powerconfig sowie ein Zugang zu Desigo CC mit Konfigurationsrechten erforderlich.],
...
Der erste betrifft die *Belastbarkeit des Fernschaltens*. UC-06 und FA-06 setzen voraus, dass sich das #acro("ECPD") elektronisch fernschalten lässt. Am Testaufbau weist das Gerät den entsprechenden Schreibzugriff derzeit mit einer Ausnahmemeldung zurück, obwohl andere schreibende Zugriffe angenommen werden und die zugehörige Freigabe gesetzt ist. Die Anforderung bleibt bestehen, wird aber unter Vorbehalt geführt; die Klärung ist Gegenstand des Validierungsteils.
