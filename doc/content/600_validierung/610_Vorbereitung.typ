...
Daneben tritt für einen einzelnen Zweck ein vierter Zugang. Der ebenfalls in @tab:werkzeuge genannte Netzwerkanalysator zeichnet den Modbus-Verkehr zwischen Desigo CC und dem Datentransceiver auf und zeigt als einziger der vier Zugänge, in welchem Abstand und in wie vielen Telegrammen der Treiber tatsächlich abfragt. Er dient allein T-03.

Der Online-Modus des #acro("PDE") fällt als drittes Prüfmittel weitgehend aus. Er ist nach @sec:pde_online auf einfache Datentypen ohne Transformation beschränkt und liefert für Zeichenketten, Wahrheitswerte und #acro("BLOB") keine Werte. Betroffen sind mit den als Zeichenkette geführten Stammdaten und der in @sec:umsetzung erprobten Zerlegung des Alarmregisters gerade jene Datenpunkte, deren Prüfung vor der Übernahme den größten Nutzen gehabt hätte. Für die numerischen Register bleibt er nutzbar, dort steht mit dem Modbus-Werkzeug jedoch bereits ein Zugang bereit.
