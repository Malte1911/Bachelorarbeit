...
Hervorgerufen wurde die Änderung dabei über SENTRON Powerconfig und nicht am Gerät selbst. Der schreibende Zugriff läuft nach @sec:geraetekonfiguration über dasselbe Powercenter, über das auch Desigo CC liest, sodass die beobachtete Zeitspanne den Weg über die Funkstrecke zum Endgerät und zurück einschließt und nicht allein die Abfrage. Für den Nachweis von T-03 ist das ohne Belang, da die Anforderung das am Treiber eingestellte Intervall betrifft und dieses die Aufzeichnung des Telegrammverkehrs unabhängig von der Anzeige belegt.

#kommentar[Zu ergänzen bleibt der Datenpunkt, an dem die Aktualisierung beobachtet wurde. Welches der drei Sendraster für ihn galt, entscheidet darüber, wie viel der beobachteten Zeitspanne auf die Funkstrecke entfällt.]
